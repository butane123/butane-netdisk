...
func (c *repositoryClient) DeleteByIdentity(ctx context.Context, in *DeleteByIdentityReq, opts ...grpc.CallOption) (*DeleteByIdentityResp, error) {
	out := new(DeleteByIdentityResp)
	err := c.cc.Invoke(ctx, "/repository.repository/deleteByIdentity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RepositoryServer interface {
	...
	DeleteByIdentity(context.Context, *DeleteByIdentityReq) (*DeleteByIdentityResp, error)
...
func (UnimplementedRepositoryServer) DeleteByIdentity(context.Context, *DeleteByIdentityReq) (*DeleteByIdentityResp, error) {
...
func _Repository_DeleteByIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteByIdentityReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RepositoryServer).DeleteByIdentity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/repository.repository/deleteByIdentity",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServer).DeleteByIdentity(ctx, req.(*DeleteByIdentityReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Repository_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Repository_DeleteByIdentity_Handler,
		},
	},
