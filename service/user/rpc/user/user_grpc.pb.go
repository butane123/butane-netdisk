...
func (c *userClient) FindVolumeByIdentity(ctx context.Context, in *FindVolumeReq, opts ...grpc.CallOption) (*FindVolumeResp, error) {
	out := new(FindVolumeResp)
	err := c.cc.Invoke(ctx, "/user.user/findVolumeByIdentity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	FindVolumeByIdentity(context.Context, *FindVolumeReq) (*FindVolumeResp, error)
...
func (UnimplementedUserServer) FindVolumeByIdentity(context.Context, *FindVolumeReq) (*FindVolumeResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindVolumeByIdentity not implemented")
}
...
func _User_FindVolumeByIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindVolumeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).FindVolumeByIdentity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.user/findVolumeByIdentity",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).FindVolumeByIdentity(ctx, req.(*FindVolumeReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "findVolumeByIdentity",
			Handler:    _User_FindVolumeByIdentity_Handler,
		},
		{
